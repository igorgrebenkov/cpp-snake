...
snake : main.o snake.o game.o 
	g++ -std=c++14 -Iinclude/ -o snake main.o snake.o game.o -lncurses

main.o : src/main.cpp
	g++ -std=c++14 -Iinclude/  -c src/main.cpp
...
snake.o : src/snake.cpp include/snake.h
	g++ -std=c++14 -Iinclude/ -c src/snake.cpp

window.o : include/window.h

game.o : src/game.cpp include/game.h
	g++ -std=c++14 -Iinclude/  -c src/game.cpp
